...
class Ideone {
  // @include
  private static class CompGPA1 implements Comparator<Student>{
  ...
  private static final Comparator<Student> compGPA2 = new Comparator<Student>() {
    @Override
    public int compare(Student a, Student b) {
      if (a.gradePointAverage != b.gradePointAverage) {
        return Double.compare(a.gradePointAverage, b.gradePointAverage);
  ...
  private static final Comparator<Student> compGPA = new CompGPA1();
